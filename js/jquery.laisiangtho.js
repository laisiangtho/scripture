...
Core.prototype.bible=function(){
    /*
    window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem;//webkitRequestFileSystem
    var someCSSCode = 'ol li h1 { color:#000!important; }';
    ...
    */
    var p=fN.Page(1), ol=$(h.ol,{id:'dragable',class:'rows row-bible'});
...
Core.prototype.book=function(){
    var p=fN.Page(2), lD=fO.lang[fO.query.bible], div=$(h.div,{class:'data-book'}).appendTo(fO.container.main.empty());
...
Core.prototype.note=function(){
    var container=$(h.div,{class:'data-com data-note d1'}).appendTo(fO.container.main.empty());
    ...
    this.Mobile={
        ...
        Parallel:function(e){
            ...
            this.Common(e,function(){
                var p=fN.Page(2);
                return {
                    msg:fN.Menu($(h.ol,{class:'rows row-parallel'})).Bible(function(Om){
...
function Database(){
    this.init=function(callback){
        ...
        this.driver().then(function(){
            delete this.init; delete this.driver;
        });
        this.ready().then(function(){
            delete this.ready; callback();
        });
    };
...
this.createProperty('Agent',function(obj){
    ...
    var o={
        meta:[{type:'script',name:'localforage.min'},{type:'script',name:'jquery.ui.touchpunch.min'},{type:'script',name:'data.bible'},{type:'script',name:'data.config'},{type:'link',name:fO.App,dir:'fonts/fontello/'}],
