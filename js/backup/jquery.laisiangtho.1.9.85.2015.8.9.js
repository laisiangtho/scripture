(function($,uA){
var z='laisiangtho', version='1.9.85.2015.8.9';
        ...
        chapter:{
            ...
            list:function(e){
                ...
                if(container.is(':hidden')){
                    ...
                    z.menu.chapter(lai.store.query.book).appendTo(container.fadeIn(200).find(z.is(z.get(x).class()[1]).id)).promise().done(function(){
