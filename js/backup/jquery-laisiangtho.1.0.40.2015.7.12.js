(function($,win,doc,uA){
var z='laisiangtho', version='1.0.40.2015.7.12';
...
return z={
	...
	utility:{
		...
		Index:function(){
			var l10=[]; config.bible.available=[];
	...
	bible:function(){
		...
		config.bible.available.forEach(function(bID){
			var lang=lai[bID].lang.info; availableClass=(lai[bID].lang.offline)?config.css.available:config.css.notAvailable;
			$(h.li,{id:bID,class:(lai.store.query.bible==bID)?config.css.active+' '+availableClass:availableClass}).html(
				$(h.p).append(
					...
					$(h.span,{class:'icon-zip offline'}).on(sO.Click,function(){
