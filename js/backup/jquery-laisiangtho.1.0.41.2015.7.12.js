(function($,win,doc,uA){
var z='laisiangtho', version='1.0.41.2015.7.12';
...
return z={
	...
	bible:function(){
		...
		config.bible.available.forEach(function(bID){
			...
			offlineClass='icon-ok offline',onlineClass='icon-cloud offline', isAvailable=(isOffline)?offlineClass:onlineClass;
			$(h.li,{id:bID,class:(lai.store.query.bible==bID)?config.css.active+' '+availableClass:availableClass}).html(
				$(h.p).append(
					$(h.span,{class:'icon-list drag'}),
