Core.prototype.bible = function() {
    ...
    fO.container.main=$('#contentmain');


    // var bibleList =new this.menu(function(Om){
    //      return $(h.li,{id:Om.bID,class:Om.classActive}).html(Om.lang.name);
    // }).bible(ol);
    // fO.container.main.html(
    //     new this.menu(function(Om){
    //          return $(h.li,{id:Om.bID,class:Om.classActive}).html(Om.lang.name);
    //     }).bible($(h.ol,{id:'dragable',class:'row row-bible'}))
    // ).promise().done(function(e){
        // this.children().sortable({
        //     handle: ".drag",containment: "parent",helper: ".dsdfd",placeholder:"ghost",forcePlaceholderSize: true,opacity: 0.7,
        //     update: function(event,ui){
    ...
    fO.container.main.html(new this.menu(function(Om){
    ...
    }).bible($(h.ol,{id:'dragable',class:'row row-bible'}))).promise().done(function(e){
        this.children().sortable({
            handle: ".drag",containment: "parent",helper: ".dsdfd",placeholder:"ghost",forcePlaceholderSize: true,opacity: 0.7,
            update: function(event,ui){
                $(this).children().each(function(i,e){
...
Core.prototype.menu=function(o){
    this.bible=function(container){
        config.bible.available.forEach(function(id){
            ...
            o(Om).appendTo(container);
        });
        return container;
    };
};
Core.prototype.bibleMenu = function(callback){
    ...
    //     Om.isAvailable=(Om.local?Om.classOffline:Om.classOnline);
    //     Om.classActive=(fO.query.bible==id?config.css.active:'')+' '+Om.classAvailable;
    //     callback(Om).appendTo(container);
    // });
    // return this.arg[0];

        // return container;
    // var container=arguments;
